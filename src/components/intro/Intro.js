        ...
        <div>
          <ul className="introbullet">
            <li className="margintop">
              ...
              Worked at
              <button className="textintro1">{/* worked at info */}</button>
              <button
                className="sidegap"
                data-toggle="modal"
                data-target="#myModal"
            ...
            <li className="margintop">
              <i className="fa fa-suitcase" />
              Went to
              <button className="textintro1">{/* went to info */}</button>
            </li>
            <li className="margintop">
              <i className="fa fa-graduation-cap" />
              Lives in
              <button className="textintro1">{/* lives in info */}</button>
            </li>
            <li className="margintop">
              <i className="fa fa-graduation-cap" />
              Address
              <button className="textintro1">{/* address info */}</button>
            </li>
            <li className="margintop">
